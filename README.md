...
- 顶部导航包含词库、学习、课文、测试、生词本、待复习和设置。手机/安卓为底部五栏：学习、课文、词库、复习、我的。
- 课文可粘贴日语文本或上传课文图片（OCR）。识别后支持：逐句朗读与跟读纠音、逐句逐词中文解释、语法标识。
- 词库按单元管理；创建单元时只填写名称。上传词汇后（以及已有占位文案的单元）会由大模型根据单词归纳 4–12 字中文主题。
